...
import com.makesystem.pidgey.thread.old.SchedulePool;
import com.makesystem.pidgey.thread.old.ThreadPool;
 ...
 */
public class Thread_Tester_OLD extends AbstractTester {

    public static void main(String[] args) {
        new Thread_Tester_OLD().run();
    }
    ...
    void testExecuteAll() {
        ...
        Console.log("class: {s}", pool.execute(() -> Console.log()).getClass().getName());
