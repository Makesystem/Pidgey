...
public final class Executors {
    ...
    public static final class Fixed {
        ...
        public static ExecutorService single(final String poolName) {
            return single(poolName, null);
        }

        public static ExecutorService single(final ThreadFactory threadFactory) {
    ...
    public static final class Adaptive {
        ...
        public static ExecutorService single(final long keepAliveTime) {
        ...
        public static ExecutorService single(final long keepAliveTime, final String poolName) {
        ...
        public static ExecutorService single(final String poolName, final ThreadFactory threadFactory) {
            return single(0L, poolName, threadFactory);
        }

        public static ExecutorService single(final long keepAliveTime, final String poolName, final ThreadFactory threadFactory) {
    ...
    public static final class Cached {
        ...
        protected static final ExecutorService INSTANCE = create("cached--pool");
        ...
        public static ExecutorService create(final String poolName) {
            return create(poolName, null);
        }

        public static ExecutorService create(final ThreadFactory threadFactory) {
            return create(null, threadFactory);
        }

        public static ExecutorService create(final String poolName, final ThreadFactory threadFactory) {
    ...
    public static final class Schedule {
        ...
        public static ScheduledExecutorService create(final String name) {
            return create(0, name);
        }

        public static ScheduledExecutorService create(final int corePoolSize) {
            return create(corePoolSize, null);
        }

        public static ScheduledExecutorService create(final int corePoolSize, final String name) {
