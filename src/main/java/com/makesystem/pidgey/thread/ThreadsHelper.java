...
public class ThreadsHelper implements Serializable {
     ...
     * thread's id match the specified id. {@code null} is returned if no such
     * thread exists
     * @throws IllegalArgumentException if the specified id is zero or negative
     * or the group is null
     ...
     * groups from this thread's thread group up to the system thread group
     */
     ...
     * group name and the thread's id match the specified id. {@code null} is
     * returned if no such thread exists
     * @throws IllegalArgumentException if the specified id is zero or negative
     * or the group name is null
     * @throws SecurityException if the current thread cannot access the system
     * thread group
     *
     * @throws SecurityException if the current thread cannot modify thread
     ...
     * @param threadGroupName The thread group name
     * @return The threads which belongs to a thread group with the specified
     * group name and the thread's name match the specified name, An empty
     * collection is returned if no such thread exists. The collection returned
     ...
     * such thread exists. The collection returned is always unmodifiable.
     ...
     * match the given predicate and which is a subgroup of the given thread
     * group
     * @throws IllegalArgumentException if the given group or predicate is null
     * @throws SecurityException if the current thread cannot modify thread
     * groups from this thread's thread group up to the system thread group
