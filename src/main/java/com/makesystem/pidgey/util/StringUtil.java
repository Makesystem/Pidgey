...
public class StringUtil extends StringUtilImpl {
    ...
    public static void main(String[] args) {
        ...
        list.add("R SORIANO DE SOUSA|EDI:TOWER PORTO SEGURO_CDOE1_ANDAR 14 A 15, 189, SAO PAULO - SP, CEP 03066020");

        List<FilteredAddress> address = filter(list, "SOUS", null, null, null, new String[]{":", ","}, null);
