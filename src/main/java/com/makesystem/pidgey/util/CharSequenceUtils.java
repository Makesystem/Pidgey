...
public class CharSequenceUtils {
     ...
     * starting with the {@code char} value at the specified index.</p>
     *
     * <p>
...
//        }
     ...
     * (this.charAt(<i>k</i>) == searchChar) &amp;&amp; (<i>k</i> &lt;= start)
     * </pre></blockquote>
     * is true. For other values of <code>searchChar</code>, it is the largest
     * value <i>k</i> such that:
     * <blockquote><pre>
     * (this.codePointAt(<i>k</i>) == searchChar) &amp;&amp; (<i>k</i> &lt;= start)
     * </pre></blockquote>
     * is true. In either case, if no such character occurs in <code>cs</code>
     * at or before position <code>start</code>, then <code>-1</code> is
     * returned.
     *
     * <p>
     * All indices are specified in <code>char</code> values (Unicode code
