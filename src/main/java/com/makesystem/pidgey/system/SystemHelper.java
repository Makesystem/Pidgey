...
public class SystemHelper {
     ...
     * string containing a single character and it does not require a privilege
     * check.
     * @since Java 1.1
     */
    @Deprecated
     ...
     * a string containing a single character and it does not require a
     * privilege check.
     * @since Java 1.1
     */
    @Deprecated
    ...
    /**
     * Gets the host name from an environment variable (COMPUTERNAME on Windows,
     * HOSTNAME elsewhere).
     *
     * <p>
     ...
     * </p>
     *
     * @return the host name. Will be {@code null} if the environment variable
     * is not defined.
     * @since 3.6
     */
     ...
     * <p>
     * If a {@code SecurityException} is caught, the return value is
     * {@code defaultValue} and a message is written to {@code System.err}.
     * </p>
     *
     ...
     *
     * @return {@code true} if {@code JAVA_AWT_HEADLESS} is
    ...
    static boolean isOSVersionMatch(final String osVersion, final String osVersionPrefix) {
        if (StringHelper.isEmpty(osVersion)) {
            return false;
        }
