 ...
 * @since 1.2.37
 */
@SuppressWarnings({"UnnecessaryUnboxing", "UnnecessaryBoxing", "SuspiciousSystemArraycopy"})
public class ArrayHelper {
     ...
     * {@link #insert(int, boolean[], boolean...)} and may be removed in a
     * future release. Please note the handling of {@code null} input arrays
     * differs in the new method: inserting {@code X} into a {@code null} array
     ...
     * &lt; 0 || index &gt; array.length).
     * @deprecated this method has been superseded by
     * {@link #insert(int, byte[], byte...)} and may be removed in a future
     * release. Please note the handling of {@code null} input arrays differs in
     * the new method: inserting {@code X} into a {@code null} array results in
     ...
     * &lt; 0 || index &gt; array.length).
     * @deprecated this method has been superseded by
     * {@link #insert(int, char[], char...)} and may be removed in a future
     * release. Please note the handling of {@code null} input arrays differs in
     * the new method: inserting {@code X} into a {@code null} array results in
     * {@code null} not {@code X}.
     */
     ...
     * &lt; 0 || index &gt; array.length).
     * @deprecated this method has been superseded by
     * {@link #insert(int, double[], double...)} and may be removed in a future
     * release. Please note the handling of {@code null} input arrays differs in
     * the new method: inserting {@code X} into a {@code null} array results in
     * {@code null} not {@code X}.
     */
     ...
     * &lt; 0 || index &gt; array.length).
     * @deprecated this method has been superseded by
     * {@link #insert(int, float[], float...)} and may be removed in a future
     * release. Please note the handling of {@code null} input arrays differs in
     * the new method: inserting {@code X} into a {@code null} array results in
     * {@code null} not {@code X}.
     */
     ...
     * &lt; 0 || index &gt; array.length).
     * @deprecated this method has been superseded by
     * {@link #insert(int, int[], int...)} and may be removed in a future
     * release. Please note the handling of {@code null} input arrays differs in
     * the new method: inserting {@code X} into a {@code null} array results in
     * {@code null} not {@code X}.
     */
     ...
     * &lt; 0 || index &gt; array.length).
     * @deprecated this method has been superseded by
     * {@link #insert(int, long[], long...)} and may be removed in a future
     * release. Please note the handling of {@code null} input arrays differs in
     * the new method: inserting {@code X} into a {@code null} array results in
     * {@code null} not {@code X}.
     */
     ...
     * &lt; 0 || index &gt; array.length).
     * @deprecated this method has been superseded by
     * {@link #insert(int, short[], short...)} and may be removed in a future
     * release. Please note the handling of {@code null} input arrays differs in
     * the new method: inserting {@code X} into a {@code null} array results in
     * {@code null} not {@code X}.
     */
     ...
     * @deprecated this method has been superseded by
     * {@link #insert(int, Object[], Object...) insert(int, T[], T...)} and may
     * be removed in a future release. Please note the handling of {@code null}
     * input arrays differs in the new method: inserting {@code X} into a
     ...
     * @return A new array containing the existing elements plus the new element
     * The returned array type will be that of the input array (unless null), in
     * which case it will have the same type as the element. If both are null,
    ...
    /**
     * Copies the given array and adds the given element at the beginning of the
     * new array.
     *
     * <p>
     * The new array contains the same elements of the input array plus the
     * given element in the first position. The component type of the new array
     * is the same as that of the input array.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * This method returns an empty BitSet for a {@code null} input array.</p>
     *
     ...
     * array length will return an empty BitSet ({@code -1}).</p>
     *
     * @param array the array to search through for the object, may be
     * {@code null}
     * @param valueToFind the value to find
     * @param startIndex the index to start searching at
     * @return a BitSet of all the indices of the value within the array, an
     * empty BitSet if not found or {@code null} array input
     * @since 3.10
     */
     ...
     * <p>
     * A negative startIndex is treated as zero. A startIndex larger than the
     * array length will return an empty BitSet.</p>
     *
     * @param array the array to search through for the object, may be
     * {@code null}
     * @param valueToFind the value to find
     ...
     *
     * <p>
     * This method returns empty BitSet for a {@code null} input array.</p>
     *
     * @param array the array to search through for the object, may be
     * {@code null}
     * @param valueToFind the value to find
    ...
    /**
     * Finds the indices of the given value within a given tolerance in the
     * array.
     *
     * <p>
     * This method will return all the indices of the value which fall between
     * the region defined by valueToFind - tolerance and valueToFind +
     * tolerance, each time between the nearest integers.
     * </p>
     *
     * <p>
     * This method returns an empty BitSet for a {@code null} input array.</p>
     ...
     * <p>
     * A negative startIndex is treated as zero. A startIndex larger than the
     * array length will return empty BitSet.</p>
     *
     * @param array the array to search through for the object, may be
     * {@code null}
     * @param valueToFind the value to find
     ...
     * @return a BitSet of all the indices of the object within the array, an
     * empty BitSet if not found or {@code null} array input
     * @since 3.10
     */
     ...
     * starting at the index, an empty BitSet if not found or {@code null} array
     * input
     * @since 3.10
     */
     ...
     * {@link #INDEX_NOT_FOUND} ({@code -1}) if not found or {@code null} array
     * input
     */
...
//-----------------------------------------------------------------------
    ...
    /**
     * <p>
     * Inserts elements into an array at the given index (starting from
     * zero).</p>
     *
     * <p>
     * When an array is returned, it is always a new array.</p>
     *
     * <pre>
     ...
     * array input.
     *
     * @param array the array to traverse backwards looking for the object, may
     * be {@code null}
...
//        }
     ...
     * removed from the array. {@code null} will be returned if the input array
     * is {@code null}.
     * </p>
     *
     ...
     * promoted to 0, overvalue (&gt;array.length) results in no change.
     * @param endIndexExclusive elements up to endIndex-1 are reversed in the
     * array. Undervalue (&lt; start index) results in no change. Overvalue
     ...
     * promoted to 0, over value (&gt;array.length) results in no change.
     * @param endIndexExclusive elements up to endIndex-1 are reversed in the
     * array. Under value (&lt; start index) results in no change. Over value
     * (&gt;array.length) is demoted to array length.
     * @since 3.2
     */
     ...
     * @param offset The number of positions to rotate the elements. If the
     * offset is larger than the number of elements to rotate, than the
     ...
     * returned subarray. Undervalue (&lt; startIndex) produces empty array,
     ...
     * indices. Negative indices are promoted to 0(zero).</p>
     *
     * Examples:
     * <ul>
     ...
     * {@link java.util.Map.Entry} or an Array containing at least two elements,
     * may be {@code null}
     ...
     *
     * <p>
     * This method returns {@code null} for a {@code null} input array.</p>
     *
     ...
     * <p>
     * Returns an array containing the string representation of each element in
     * the argument array handling {@code null} elements.</p>
     *
     * <p>
     * This method returns {@code null} for a {@code null} input array.</p>
     *
     ...
     * {@code ArrayUtils.clone(new int[] {2})}.
     *
     * <p>
