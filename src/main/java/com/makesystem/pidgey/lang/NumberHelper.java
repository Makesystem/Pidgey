...
/**
 * <p>
 * Provides extra functionality for Java Number classes.</p>
 *
 * @since 2.0
 */
...
public class NumberHelper implements Serializable {
     ...
     *
     * <p>
     * If the string is <code>null</code>, <code>zero</code> is returned.</p>
     *
     * <pre>
     ...
     *
     * <p>
     * If the string is <code>null</code>, the default value is returned.</p>
     *
     * <pre>
    ...
    /**
     * <p>
     * Convert a <code>BigDecimal</code> to a <code>double</code>.</p>
     *
     * <p>
     * If the <code>BigDecimal</code> <code>value</code> is <code>null</code>,
     * then the specified default value is returned.</p>
     *
     * <pre>
     *   NumberUtils.toDouble(null)                     = 0.0d
     ...
     * scale of two that has been rounded using
     * <code>RoundingMode.HALF_EVEN</code>. If the supplied <code>value</code>
     * is null, then <code>BigDecimal.ZERO</code> is returned.
     *
     * <p>
     * Note, the scale of a <code>BigDecimal</code> is the number of digits to
     ...
     * scale is the specified value with a <code>RoundingMode</code> applied. If
     * the input <code>value</code> is <code>null</code>, we simply return
     * <code>BigDecimal.ZERO</code>.
     *
     * @param value the <code>BigDecimal</code> to convert, may be null.
     * @param scale the number of digits to the right of the decimal point.
     * @param roundingMode a rounding behavior for numerical operations capable
     ...
     * the supplied <code>value</code> is null, then
    ...
    /**
     * Convert a <code>Float</code> to a <code>BigDecimal</code> whose scale is
     * the specified value with a <code>RoundingMode</code> applied. If the
     * input <code>value</code> is <code>null</code>, we simply return
     * <code>BigDecimal.ZERO</code>.
     *
     * @param value the <code>Float</code> to convert, may be null.
     * @param scale the number of digits to the right of the decimal point.
     ...
     * of two that has been rounded using <code>RoundingMode.HALF_EVEN</code>.
     * If the supplied <code>value</code> is null, then
     * <code>BigDecimal.ZERO</code> is returned.
     *
     * <p>
     * Note, the scale of a <code>BigDecimal</code> is the number of digits to
    ...
    /**
     * Convert a <code>Double</code> to a <code>BigDecimal</code> whose scale is
     * the specified value with a <code>RoundingMode</code> applied. If the
     * input <code>value</code> is <code>null</code>, we simply return
     * <code>BigDecimal.ZERO</code>.
     *
    ...
    /**
     * Convert a <code>String</code> to a <code>BigDecimal</code> whose scale is
     * the specified value with a <code>RoundingMode</code> applied. If the
     * input <code>value</code> is <code>null</code>, we simply return
     * <code>BigDecimal.ZERO</code>.
     *
    ...
    /**
     * <p>
     * Turns a string value into a java.lang.Number.</p>
     *
     * <p>
     ...
     * trying to create successively larger types from the type specified until
     * one is found that can represent the value.</p>
     *
     * <p>
     ...
     *
     * <p>
     * Returns <code>null</code> if the string is <code>null</code>.</p>
     *
     * <p>
     * This method does not trim the input string, i.e., strings with leading or
     * trailing spaces will generate NumberFormatExceptions.</p>
     *
    ...
    /**
     * <p>
     * Utility method for {@link #createNumber(java.lang.String)}.</p>
     *
     * <p>
     * Returns mantissa of the given number.</p>
     *
     ...
     *
     * <p>
     * Returns <code>true</code> if s is <code>null</code>.</p>
     *
    ...
    /**
     * <p>
     * Convert a <code>String</code> to a <code>Float</code>.</p>
     *
     * <p>
     * Returns <code>null</code> if the string is <code>null</code>.</p>
     *
    ...
    /**
     * <p>
     * Convert a <code>String</code> to a <code>Double</code>.</p>
     *
     * <p>
     * Returns <code>null</code> if the string is <code>null</code>.</p>
     *
     ...
     * means octal; spaces are not trimmed.</p>
     *
     * <p>
     * Returns <code>null</code> if the string is <code>null</code>.</p>
     *
     ...
     * handles hex (0x or #) and octal (0) notations.</p>
     *
     * <p>
     * Returns <code>null</code> if the string is <code>null</code>.</p>
     *
    ...
    /**
     * <p>
     * Convert a <code>String</code> to a <code>BigDecimal</code>.</p>
     *
     * <p>
     * Returns <code>null</code> if the string is <code>null</code>.</p>
     *
    ...
    /**
     * <p>
     * Returns the minimum value in an array.</p>
     *
     ...
     * @throws IllegalArgumentException if {@code array} is either {@code null}
     * or empty
     */
    ...
    /**
     * <p>
     * Gets the minimum of three <code>long</code> values.</p>
     *
     * @param a value 1
     * @param b value 2
     * @param c value 3
    ...
    /**
     * <p>
     * Gets the minimum of three <code>int</code> values.</p>
     *
     * @param a value 1
     * @param b value 2
     * @param c value 3
    ...
    /**
     * <p>
     * Gets the minimum of three <code>short</code> values.</p>
     *
     * @param a value 1
     * @param b value 2
     * @param c value 3
    ...
    /**
     * <p>
     * Gets the minimum of three <code>byte</code> values.</p>
     *
     * @param a value 1
     * @param b value 2
     * @param c value 3
    ...
    /**
     * <p>
     * Gets the minimum of three <code>double</code> values.</p>
     *
     * <p>
    ...
    /**
     * <p>
     * Gets the minimum of three <code>float</code> values.</p>
     *
     * <p>
     * If any value is <code>NaN</code>, <code>NaN</code> is returned. Infinity
     * is handled.</p>
    ...
    /**
     * <p>
     * Gets the maximum of three <code>long</code> values.</p>
     *
     * @param a value 1
     * @param b value 2
     * @param c value 3
    ...
    /**
     * <p>
     * Gets the maximum of three <code>int</code> values.</p>
     *
     * @param a value 1
     * @param b value 2
     * @param c value 3
    ...
    /**
     * <p>
     * Gets the maximum of three <code>short</code> values.</p>
     *
     * @param a value 1
     * @param b value 2
     * @param c value 3
    ...
    /**
     * <p>
     * Gets the maximum of three <code>byte</code> values.</p>
     *
     * @param a value 1
     * @param b value 2
     * @param c value 3
    ...
    /**
     * <p>
     * Gets the maximum of three <code>double</code> values.</p>
     *
     * <p>
     * If any value is <code>NaN</code>, <code>NaN</code> is returned. Infinity
     * is handled.</p>
    ...
    /**
     * <p>
     * Gets the maximum of three <code>float</code> values.</p>
     *
     * <p>
     * If any value is <code>NaN</code>, <code>NaN</code> is returned. Infinity
     * is handled.</p>
    ...
    /**
     * <p>
     * Checks whether the <code>String</code> contains only digit
     * characters.</p>
     *
     * <p>
     * <code>Null</code> and empty String will return <code>false</code>.</p>
     *
     ...
     * octal values. Thus the string <code>09</code> will return
    ...
    public static boolean isCreatable(final String str) {
        ...
        if (sz > start + 1 && chars[start] == '0' && !StringHelper.contains(str, '.')) { // leading 0, skip if is a decimal number
    ...
    /**
     * <p>
     * Checks whether the given String is a parsable number.</p>
     *
     * <p>
     ...
     * catching {@link java.text.ParseException} when calling one of those
     * methods.</p>
     *
     * <p>
     * Hexadecimal and scientific notations are <strong>not</strong> considered
     * parsable. See {@link #isCreatable(String)} on those cases.</p>
     *
     * <p>
     * {@code Null} and empty String will return <code>false</code>.</p>
     *
     * @param str the String to check.
    ...
    /**
     * <p>
     * Compares two {@code int} values numerically. This is the same
     * functionality as provided in Java 7.</p>
     *
    ...
    /**
     * <p>
     * Compares to {@code long} values numerically. This is the same
     * functionality as provided in Java 7.</p>
     *
    ...
    /**
     * <p>
     * Compares to {@code short} values numerically. This is the same
     * functionality as provided in Java 7.</p>
     *
