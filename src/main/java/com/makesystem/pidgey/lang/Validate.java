 ...
 * <a href="http://docs.oracle.com/javase/1.5.0/docs/api/java/util/Formatter.html#syntax">format
 * strings</a>
...
public class Validate {
     ...
     * and appended to the exception message only in the case of an error.</p>
     *
     ...
     * using your own custom validation expression.</p>
     *
     * <pre>
     * Validate.isTrue(i &gt; 0);
     ...
     * <p>
     * If the index is invalid, then the message of the exception is &quot;The
     * validated collection index is invalid: &quot; followed by the index.</p>
     *
     * @param <T> the collection type
     * @param collection the collection to check, validated not null by this
     * method
     ...
     * sequence; otherwise throwing an exception with the specified message.</p>
     *
     ...
     * <p>
     * Validates that the index is within the bounds of the argument character
     * sequence; otherwise throwing an exception.</p>
     *
     ...
     *
     * <p>
     * The message of the exception is &quot;The value is invalid: %f&quot;.</p>
     *
     * @param value the value to validate
