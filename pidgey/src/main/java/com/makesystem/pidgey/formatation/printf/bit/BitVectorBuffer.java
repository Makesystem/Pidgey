...
package com.makesystem.pidgey.formatation.printf.bit;
    ...
    implements Comparable, Serializable
{
     ...
     * @throws IllegalArgumentException - if either this BitVectorBuffer or obj
     *             contains X/Z values
     */
    public int compareTo(Object obj)
    {
        ...
        {
            throw new IllegalArgumentException("compareTo doesn't support X/Z values: "
                + this.toString(2));
        }
     ...
     * by {@link BitConverter#toBitVector(Object)}.
     *
    ...
    public static BitVectorBuffer concat(Object... values)
    {
        ...
        {
            buffers[i] = BitConverter.toBitVector(values[i]).myBuffer;
     ...
     * @throws IllegalArgumentException if an X/Z value is present in the BitVectorBuffer
     */
    @Override
    ...
    public int intValue()
    {
        ...
        if (containsXZ())
        {
            throw new IllegalArgumentException("X/Z value is not numeric: "
                + this.toString(2));
        }
     ...
     * @throws IllegalArgumentException BitVectorBuffer contains X/Z values
     */
    ...
    private byte[] getBytes(boolean minimalSize, boolean forceUnsigned)
    {
        ...
        if (containsXZ())
        {
            throw new IllegalArgumentException("getBytes doesn't support X/Z: "
                + this.toString(2));
        }
