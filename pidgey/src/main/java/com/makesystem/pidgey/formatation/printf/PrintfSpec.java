...
final class PrintfSpec {
    ...
    /**
     * The object to be formatted. This may be <code>null</code>, for example in
     * no-argument format specifications.
     */
    public final Object obj;

    /**
     * The starting index of this printf specification in the original format
     * string. For example, in "01%4s56", the startIdx would be 2 since index 2
     * is where the printf specification "%4s" starts.
     */
    public final int startIdx;

    /**
     * The ending index of this printf specification in the original format
     * string. For example, in "01%4s56", the startIdx would be 4 since index 4
     * is where the printf specification "%4s" ends.
     */
     ...
     * unsupported object with %s -- in this case, we have to call toString() on
     * the object to get its length). in this case we should just cache the
     ...
     * {@link #cachedString}, the exact length required for the formatted string
     * may be calculated early on, in which case it is cached here.
     * <P>
     * However, the contents of this field are not strictly specified and
     * {@link ConversionFormatter} objects may use it as needed to cache values
     * that are expensive to calculate.
     ...
     * @param endIdx the ending index of this specifier string in the original
     * format string
     ...
     * @param widthIsValid <code>true</code> if <code>width</code> is value,
